...
import useSellerResetModal from "@/app/hooks/useSellerResetModal";
...
const SellerResetModal: React.FC<ResetModalProps> = ({
  verify
}
) => {
  ...
  const onSubmit: SubmitHandler<FieldValues> =
    (data) => {
      ...
      axios.post(`/api/sellerresetpassword`, {
...
export default SellerResetModal;
